const categoryIcons = {
  rengjoring: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 21h3l2-9H5L3 21zM8 12l1-5h6l1 5M16 12l2 9h3l-2-9M12 3v4M9 7h6" />
    </svg>
  ),
  'hage-og-utearbeid': (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 22V10M7 10c0-3 2-5 5-8 3 3 5 5 5 8a5 5 0 01-10 0z" />
    </svg>
  ),
  smajobber: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  'kjoring-og-folge': (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M5 17H3v-6l2-5h9l4 5h3v6h-2M5 17h8m4 0h-4" />
      <path d="M14 6l4 5h-7" />
    </svg>
  ),
  barnepass: (
  ...
  turfolge: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M13 4L2 20h11l1-4M14 12l4-8 4 8M15 16h6M18 4v0" />
    </svg>
  ),
  matlaging: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a4 4 0 00-4 4v4h8V6a4 4 0 00-4-4zM6 10h12a2 2 0 012 2v1a8 8 0 01-16 0v-1a2 2 0 012-2z" />
