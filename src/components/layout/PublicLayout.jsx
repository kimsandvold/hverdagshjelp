          ...
          <div className="border-t border-gray-100 bg-gray-50/50 px-4 pb-4 pt-3 space-y-1">
            ...
            {isAuthenticated && (
              <>
                ...
                {role === 'helper' && (
                  <NavLink to="/dashboard" className={({ isActive }) => `block rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${isActive ? 'bg-primary-50 text-primary-500' : 'text-gray-700 hover:bg-gray-100'}`}>
                    Dashboard
                  </NavLink>
                )}
                {role === 'admin' && (
